...
import {
  ...
  Laos,
  China,
} from "~/lib/language-pages/pages/pages/checkout";
  ...
  const fetcherPreOrder = async () => {
    if (currentUser) {
      ...
      const filterStatus = preOrders.filter(
        (item) => item.po_status === "รอชำระเงิน"
      );
              ...
              >
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        {value.po_status === "รอชำระเงิน" &&
                          storeLanguage.WaitForPay}{" "}
                        <Button
                          color="error"
                          variant="outlined"
                ...
                <CardActions sx={{ justifyContent: "space-between" }}>
                  ...
                  <div style={{ justifyContent: "center", display: "flex" }}>
                    ...
                    <Link
                      href={{
                        pathname: "/pages/checkout/detail",
                        query: { list: value._id },
                      }}
                    >
                      <Button
                        variant="outlined"
