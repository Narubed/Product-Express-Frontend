...
export default function NewsletterModal () {
    ...
    return (
        ...
        <div className="newsletter-popup" id="newsletter-popup" style={ { backgroundImage: "url('https://d-themes.com/react/riode/demo-19/images/newsletter-popup.jpg')" } }>
            {/* <div className="newsletter-popup" id="newsletter-popup" style={ { backgroundImage: "url(images/newsletter-popup.jpg)" } }> */}
                <div className="newsletter-content">
                    ...
                    <h2 className="font-weight-semi-bold">Sign up to <span>NBA</span></h2>
